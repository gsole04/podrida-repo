...
const T_STEPS = [
  {text:"Benvingut al tutorial! A continuació aprendrem a jugar a la Podrida. Toca la pantalla per continuar."},
  {text:"La base de la Podrida és guanyar mans. Dins de cada pal, les cartes s'ordenen així: A · 3 · 12 · 11 · 10 · 7 · 6 · 5 · 4 · 2", showOrder:true},
  ...
  {text:"L'última carta de la baralla és el 3 de Bastos. Això vol dir que el trumfo d'aquesta ronda és Bastos — les cartes de Bastos guanyen qualsevol altra!"},
  ...
  {text:"No tens Ors ni trumfo. No pots seguir ni superar. Pots tirar qualsevol carta — descarta el 7 de Copes.", forceCard:{pal:'Copes',valor:7}},
  {text:"El Bot1 no tenia Ors però tenia trumfo."},
  {text:"Només et queda el 10 d'Espases. Juga'l — guanyaràs la mà!", forceCard:{pal:'Espases',valor:10}},
  {text:"El Bot2 no tenia Espases ni trumfo — pot tirar el que vulgui."},
  {text:"Ronda 1: Tu 1 mà ✓ (+13 pts) · Bot1 1 mà ✓ (+13 pts) · Bot2 1 de 2 ✗ (-3 pts)."},
  {text:"Trumfo nou: Copes (5 de Copes al munt). Regla clau: seguir el pal és sempre prioritari, fins i tot quan tens trumfo."},
  {text:"Tens el 12 d'Espases i el 3 de Copes (trumfo). Hauries de fer 1 mà. Canta 1.", forceBid:1},
  {text:"Tens el 12 d'Espases i el 3 de Copes (trumfo). Voldries jugar el trumfo... però primer has de seguir el pal! El 12 no supera l'As, però l'has de jugar igualment.", forceCard:{pal:'Espases',valor:12}},
  {text:"Seguir el pal és obligatori fins i tot si no pots superar i tens trumfo a la mà."},
  {text:"Només et queda el 3 de Copes (trumfo). Juga'l — supera el 7 i guanyes la mà!", forceCard:{pal:'Copes',valor:3}},
  ...
  {text:"Última ronda! 1 carta per cap. Trumfo: Ors (7 d'Ors al munt)."},
  {text:"Tens l'As d'Ors — el trumfo més fort! Canta 1.", forceBid:1},
  {text:"No tens Bastos, però tens l'As d'Ors (trumfo). Quan no pots seguir el pal, has de jugar trumfo per superar. L'As d'Ors guanya sempre!", forceCard:{pal:'Ors',valor:1}},
  {text:"Tutorial completat! Ara ja coneixes les regles bàsiques: seguir el pal, superar si pots, i el trumfo guanya tot. Bona sort a la Podrida!"},
];
const T_TRIGGERS = [
...
// ══ Card Components ════════════════════════════════════════════════════════
function CardFront({ carta, selected, disabled, onClick, size = "md", highlight = false }) {
